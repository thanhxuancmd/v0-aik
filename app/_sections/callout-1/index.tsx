...
const testimonial = {
  content:
    "AIK đã thay đổi hoàn toàn cách chúng tôi làm việc. Từ việc tự động hóa quy trình đến tạo nội dung, mọi thứ đều trở nên dễ dàng và hiệu quả hơn rất nhiều.",
  author: {
    ...
    <section className="relative py-24 bg-gradient-to-br from-gray-900 via-purple-900 to-blue-900 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">{calloutFragment.title}</h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">{calloutFragment.subtitle}</p>
        </div>
          ...
          <Card className="bg-white/10 backdrop-blur-sm border-white/20 max-w-4xl mx-auto">
            <CardContent className="p-8">
              <div className="text-center mb-6">
                ...
                <blockquote className="text-xl text-gray-200 italic mb-6">"{testimonial.content}"</blockquote>
              </div>
