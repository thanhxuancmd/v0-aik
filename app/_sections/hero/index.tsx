      ...
      <div className="relative container mx-auto px-4 py-20">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-20">
          ...
          <Button
            size="lg"
            variant="outline"
            className="w-full sm:w-auto border-white/30 text-white hover:bg-white/10 rounded-xl px-8 py-4 text-lg font-medium transition-all duration-300 backdrop-blur-sm bg-transparent"
          >
            Đăng AI Agent
          </Button>
          <Button
        ...
        {/* Categories grid removed from Hero to avoid duplication on homepage */}
      </div>
    </section>
  )
}
