...
const getSheetClasses = (side: keyof typeof sheetVariants.sides = "right") => {
  return `${sheetVariants.base} ${sheetVariants.sides[side]}`
}
...
const SheetContent = React.forwardRef<React.ElementRef<typeof SheetPrimitive.Content>, SheetContentProps>(
  ({ side = "right", className, children, ...props }, ref) => (
    <SheetPortal>
      <SheetOverlay />
      <SheetPrimitive.Content ref={ref} className={cn(getSheetClasses(side), className)} {...props}>
        {children}
